...
V="v0.0.0-20210325080927-3ddb3b001b30"
...
EGO_SUM=(
        ...
        "cloud.google.com/go v0.80.0/go.mod"
        ...
        "github.com/danjacques/gofslock v0.0.0-20200623023034-5d0bd0fa6ef0/go.mod"
        ...
        "github.com/maruel/subcommands v1.1.0/go.mod"
        "github.com/maruel/ut v1.0.2"
        "github.com/maruel/ut v1.0.2/go.mod"
        ...
        "go.chromium.org/luci v0.0.0-20210325080927-3ddb3b001b30"
        "go.chromium.org/luci v0.0.0-20210325080927-3ddb3b001b30/go.mod"
        ...
        "google.golang.org/genproto v0.0.0-20210323160006-e668133fea6a/go.mod"
        "google.golang.org/genproto v0.0.0-20210325224202-eed09b1b5210"
        "google.golang.org/genproto v0.0.0-20210325224202-eed09b1b5210/go.mod"
...
SRC_URI="https://proxy.golang.org/go.chromium.org/luci/@v/${V}.zip
		${EGO_SUM_SRC_URI}"
...
S="${WORKDIR}/go.chromium.org/luci@${V}/cipd/client/cmd/cipd"



src_compile() 
{
	cp ${FILESDIR}/go.sum . || die
	cp ${FILESDIR}/go.mod . || die
